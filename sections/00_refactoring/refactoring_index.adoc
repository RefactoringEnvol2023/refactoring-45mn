...
** Besoins humains => code informatique
** _Traduire, c'est trahir_
* La complexité engendre la complexité
** Complexité des outils techniques
** Problème humain complexe => code complexe
* Développement => activité complexe peut devenir vite très compliquée
** Beaucoup (trop) d'éléments & d'aspects à prendre en compte
...
Réussir à développer un logiciel, {cr}
...
* Adopter une démarche _itérative_ et _incrémentale_
** Ajouts de fonctionnalité successifs & feedback rapide du client
...
[.center]
*****
Faire évoluer un logiciel à un rythme **soutenable** => s'assurer de sa maintenabilité
*****


== Maintenabilité

Qualité norme ISO 9126 => Mesure de la facilité
...
** En fonction des contraintes (temps/budget/compétences/expertises disponibles)
* Dette technique
** _Dette_ :  Renoncement accélérant le développement
** _Remboursement_ : Réécriture du code
* Endettement
** La dette non-remboursée engendre de la dette supplémentaire.
...
_sans changer son comportement observable_
...
=== Refactoring : capacitée d'évolution comme critère de qualité
...
** Mais ça vaut le coup de les parcourir et lire la motivation derrière chacune !
--
