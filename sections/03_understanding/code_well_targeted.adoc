...
Coder, c'est structurer un texte

== Distinguer l'intention de l'implémentation
...
Quel est l'objectif de l'entité ?
...
Comment l'entité réalise son objectif ?
...
[.center]
--
Erreur de conception courante: mélanger intention et implémentation
_Surtout chez les développeuses et développeurs_
--


=== Démarche

Le cas ci-dessous est une illustration
...
* Commencer par écrire le code est une erreur
...
[.simple]
Définissez ce que vous voulez, l'*intention*, d'une manière très abstraite.
...
[.simple]
Réfléchissez à la manière de l'obtenir, d'une manière un peu moins abstraite

[.center]
image::images/good_practices-what_how_call_hierarchie_1.svg[]

[.simple]
mais sans aller dans le détail.
...
== Techniques de refactoring associées au nommage
